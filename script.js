...
function changeTheme() {
    ...
    // Atualizar botão de autoplay com a nova cor
    updateAutoplayButton();
    
    console.log(`%c🎨 Tema alterado: ${themeNames[newTheme]}`, 
        'color: var(--neon-primary); font-size: 12px;');
}
...
console.log('%cNeonOn %cReady - Vídeos + Imagens + Cores Dinâmicas!',
    'color: #00ff88; font-size: 16px; text-shadow: 0 0